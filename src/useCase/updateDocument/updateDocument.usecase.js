...
const { updateDocumentRepository } = require("../../repository/updateDocumentRepository");
...
const updateDocumentUseCase = async (req, res) => {
    ...
    try {
        ...
        upload.single('file')(req, res, async (err) => {
          ...
          const saveDocs = await updateDocumentRepository(document_name, id, generatedFileName,'NLU define');
